...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "myserver1" do |myserver1|
   ...
   myserver1.vm.network :private_network, ip: "33.33.33.13"
  ...
  config.vm.define "myserver2" do |myserver2|
   ...
   myserver2.vm.network :private_network, ip: "33.33.33.11"
  ...
  config.vm.define "myserver3" do |myserver3|
   ...
   myserver3.vm.network :private_network, ip: "33.33.33.12"
